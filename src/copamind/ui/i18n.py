...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "pt-BR": {
        ...
        "nav_pool": "Bolão de IAs",
        "pool_title": "Bolão de IAs Locais",
        "pool_run": "Rodar bolão (backtest)",
        "predictor": "Preditor",
        "pool_predictions": "Palpites",
        "pool_points": "Pontos",
        "pool_exact": "Placar exato",
        ...
        "bracket_path": "Caminho até o título (probabilidade por fase)",
    ...
    "en": {
        ...
        "nav_pool": "AI Pool",
        "pool_title": "Local AI Prediction Pool",
        "pool_run": "Run pool (backtest)",
        "predictor": "Predictor",
        "pool_predictions": "Predictions",
        "pool_points": "Points",
        "pool_exact": "Exact score",
        ...
        "bracket_path": "Path to the title (probability by stage)",
